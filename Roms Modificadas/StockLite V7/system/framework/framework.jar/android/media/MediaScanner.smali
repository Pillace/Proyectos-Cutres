...
.field private static final AUDIO_UNSUPPORTED:Ljava/lang/String; = "audio/unsupported"
...
.method static constructor <clinit>()V
    ...
    .line 412
    sput v3, Landroid/media/MediaScanner;->generation:I
...
.method private postscan([Ljava/lang/String;)V
    ...
    const-string/jumbo v9, "postscan enter: directories - "
    ...
    invoke-interface {v8, v9}, Landroid/content/IContentProvider;->modifyALLMediaDBTriggers(Z)V
    ...
    invoke-interface {v8, v9, v7, v10, v11}, Landroid/content/IContentProvider;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    :cond_79
    iget v8, p0, Landroid/media/MediaScanner;->mGeneration:I

    sget v9, Landroid/media/MediaScanner;->generation:I
    ...
    const-string v9, "Device is shutting down!! reeturn postscan. Do not need to call MediaProvider.delete()"
    ...
    invoke-interface {v8, v9, v10, v11}, Landroid/content/IContentProvider;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    iput-object v8, p0, Landroid/media/MediaScanner;->mGenreCache:Ljava/util/HashMap;

    .line 1819
    const/4 v8, 0x0

    iput-object v8, p0, Landroid/media/MediaScanner;->mPlayLists:Ljava/util/ArrayList;

    .line 1820
    const/4 v8, 0x0

    iput-object v8, p0, Landroid/media/MediaScanner;->mFileCache:Ljava/util/HashMap;
    ...
    const-string/jumbo v9, "postscan return"
...
.method private prescan(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "prescan return"
...
.method private processPlayLists()V
    ...
    :try_end_e9
    .catchall {:try_start_cc .. :try_end_e9} :catchall_169
...
.method private pruneDeadThumbnailFiles()V
    ...
    const-string v2, "Thumbnails to be deleted : "
    ...
    :try_end_b6
    .catchall {:try_start_3b .. :try_end_b6} :catchall_ed
    .catch Landroid/os/RemoteException; {:try_start_3b .. :try_end_b6} :catch_c9
    ...
    invoke-direct {v1, p0, v9}, Landroid/media/MediaScanner$1;-><init>(Landroid/media/MediaScanner;Ljava/util/HashSet;)V
    ...
    :try_end_e7
    .catchall {:try_start_cb .. :try_end_e7} :catchall_ed
