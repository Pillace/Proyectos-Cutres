...
.method private initializeSyncAdapter(Landroid/accounts/Account;Ljava/lang/String;)V
    ...
    invoke-static {v7, v3}, Landroid/util/secutil/Log;->isLoggable(Ljava/lang/String;I)Z
    ...
    const-string v4, "initializeSyncAdapter: authority "
    ...
    invoke-static {v7, v3}, Landroid/util/secutil/Log;->v(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v7, v3}, Landroid/util/secutil/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
...
.method private sendCheckAlarmsMessage()V
    ...
    invoke-static {v1, v0}, Landroid/util/secutil/Log;->isLoggable(Ljava/lang/String;I)Z
...
.method private sendSyncAlarmMessage()V
    ...
    invoke-static {v2, v1}, Landroid/util/secutil/Log;->isLoggable(Ljava/lang/String;I)Z
...
.method private sendSyncFinishedOrCanceledMessage(Landroid/content/SyncManager$ActiveSyncContext;Landroid/content/SyncResult;)V
    ...
    invoke-static {v2, v1}, Landroid/util/secutil/Log;->v(Ljava/lang/String;Ljava/lang/String;)I
...
.method protected dumpSyncState(Ljava/io/PrintWriter;Ljava/lang/StringBuilder;)V
    ...
    monitor-exit v29
    :try_end_1d0
    .catchall {:try_start_1a4 .. :try_end_1d0} :catchall_35a
    ...
    monitor-exit v29
    :try_end_35c
    .catchall {:try_start_35b .. :try_end_35c} :catchall_35a
...
.method maybeRescheduleSync(Landroid/content/SyncResult;Landroid/content/SyncOperation;)V
    ...
    const-string v0, "not retrying sync operation because SYNC_EXTRAS_DO_NOT_RETRY was specified"
    ...
    const-string v0, "not retrying sync operation because it retried too many times"
    ...
    const-string v0, "not retrying sync operation because the error is a hard error"
...
.method public scheduleSync(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;JZ)V
    ...
    const-string/jumbo v7, "scheduleSync: sync of "
    ...
    invoke-static {v3, v7}, Landroid/util/secutil/Log;->v(Ljava/lang/String;Ljava/lang/String;)I
...
.method public scheduleSyncOperation(Landroid/content/SyncOperation;)V
    ...
    invoke-static {v5, v3}, Landroid/util/secutil/Log;->v(Ljava/lang/String;Ljava/lang/String;)I
